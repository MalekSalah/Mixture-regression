...
Given the p-values of the two tests, we can confirm that the Markov chain reached stationarity and that what we're observing is our target distribution.
